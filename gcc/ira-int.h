...
typedef unsigned short move_table[MULTI_TARGET_UNION_N_REG_CLASSES];
...
struct ira_loop_tree_node
{
  ...
  int reg_pressure[MULTI_TARGET_UNION_N_REG_CLASSES];
...
public:
  ...
  HARD_REG_SET (x_ira_reg_mode_hard_regset
		[MULTI_TARGET_UNION_FIRST_PSEUDO_REGISTER][NUM_MACHINE_MODES]);
  ...
  /* Array analog of the macro MEMORY_MOVE_COST but they contain maximal
     cost not minimal.  */
  short int x_ira_max_memory_move_cost[MAX_MACHINE_MODE][MULTI_TARGET_UNION_N_REG_CLASSES][2];

  /* Map class->true if class is a possible allocno class, false
     otherwise. */
  bool x_ira_reg_allocno_class_p[MULTI_TARGET_UNION_N_REG_CLASSES];

  /* Map class->true if class is a pressure class, false otherwise. */
  bool x_ira_reg_pressure_class_p[MULTI_TARGET_UNION_N_REG_CLASSES];

  /* Array of the number of hard registers of given class which are
     available for allocation.  The order is defined by the hard
     register numbers.  */
  short x_ira_non_ordered_class_hard_regs[MULTI_TARGET_UNION_N_REG_CLASSES][MULTI_TARGET_UNION_FIRST_PSEUDO_REGISTER];

  /* Index (in ira_class_hard_regs; for given register class and hard
     register (in general case a hard register can belong to several
     register classes).  The index is negative for hard registers
     unavailable for the allocation.  */
  short x_ira_class_hard_reg_index[MULTI_TARGET_UNION_N_REG_CLASSES][MULTI_TARGET_UNION_FIRST_PSEUDO_REGISTER];
  ...
  /* Index [CL][M] contains R if R appears somewhere in a register of the form:
     ...
     in the set.  */
  HARD_REG_SET x_ira_useful_class_mode_regs[MULTI_TARGET_UNION_N_REG_CLASSES][NUM_MACHINE_MODES];
  ...
  enum reg_class x_ira_important_classes[MULTI_TARGET_UNION_N_REG_CLASSES];

  /* The array containing indexes of important classes in the previous
     array.  The array elements are defined only for important
     classes.  */
  int x_ira_important_class_nums[MULTI_TARGET_UNION_N_REG_CLASSES];

  /* Map class->true if class is an uniform class, false otherwise.  */
  bool x_ira_uniform_class_p[MULTI_TARGET_UNION_N_REG_CLASSES];
  ...
  enum reg_class x_ira_reg_class_intersect[MULTI_TARGET_UNION_N_REG_CLASSES][MULTI_TARGET_UNION_N_REG_CLASSES];
  ...
  enum reg_class x_ira_reg_class_super_classes[MULTI_TARGET_UNION_N_REG_CLASSES][MULTI_TARGET_UNION_N_REG_CLASSES];
  ...
  enum reg_class x_ira_reg_class_subunion[MULTI_TARGET_UNION_N_REG_CLASSES][MULTI_TARGET_UNION_N_REG_CLASSES];
  enum reg_class x_ira_reg_class_superunion[MULTI_TARGET_UNION_N_REG_CLASSES][MULTI_TARGET_UNION_N_REG_CLASSES];

  /* For each reg class, table listing all the classes contained in it
     (excluding the class itself.  Non-allocatable registers are
     excluded from the consideration).  */
  enum reg_class x_alloc_reg_class_subclasses[MULTI_TARGET_UNION_N_REG_CLASSES][MULTI_TARGET_UNION_N_REG_CLASSES];
  ...
  size_t x_ira_hard_regno_nrefs[MULTI_TARGET_UNION_FIRST_PSEUDO_REGISTER];
};
