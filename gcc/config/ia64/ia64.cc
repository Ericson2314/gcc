...
ia64_mt_class_max_nregs (reg_class_t rclass, machine_mode mode)
{
...
static bool
ia64_mt_profile_before_prologue (void)
{
...
#define TARGET_CLASS_MAX_NREGS ia64_mt_class_max_nregs
#undef TARGET_PROFILE_BEFORE_PROLOGUE
#define TARGET_PROFILE_BEFORE_PROLOGUE ia64_mt_profile_before_prologue
