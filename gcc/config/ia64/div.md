...
(define_insn "addrf3_cond"
  [(set (match_operand:RF 0 "fr_register_operand" "=f,f")
        (if_then_else:RF (ne:RF (match_operand:CC_PRED 1 "register_operand"  "c,c")
                                (const_int 0))
          (plus:RF
...
(define_insn "recip_approx_rf"
  [(set (match_operand:RF 0 "fr_register_operand" "=f")
   ...
   (set (match_operand:CC_PRED 3 "register_operand" "=c")
        (unspec:CC_PRED [(match_dup 1) (match_dup 2)] UNSPEC_FR_RECIP_APPROX))
  ...
  "TARGET_INLINE_FLOAT_DIV"
{
  ...
  rtx cond  = gen_reg_rtx (CC_PREDmode);
...
(define_insn "sqrt_approx_rf"
  [(set (match_operand:RF 0 "fr_register_operand" "=f")
   ...
   (set (match_operand:CC_PRED 2 "register_operand" "=c")
        (unspec:CC_PRED [(match_dup 1)] UNSPEC_FR_SQRT_RECIP_APPROX))
