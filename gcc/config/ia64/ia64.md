...
;; Processor type.  This attribute must exactly match the ia64_processor_type
...
(define_insn "movcci"
  [(set (match_operand:CC_PRED 0 "destination_operand" "=c,c,?c,?*r, c,*r,*m,*r")
	(match_operand:CC_PRED 1 "move_operand"        " O,n, c,  c,*r,*m,*r,*r"))]
  ""
  "@
   cmp.ne %0, p0 = r0, r0
   cmp.eq %0, p0 = r0, r0
...
(define_split
  [(set (match_operand:CC_PRED 0 "register_operand" "")
	(match_operand:CC_PRED 1 "register_operand" ""))]
  "reload_completed
...
(define_split
  ...
  "operands[2] = gen_rtx_REG (CC_PREDmode, REGNO (operands[0]));
   operands[3] = gen_rtx_REG (CC_PREDmode, REGNO (operands[0]) + 1);
   operands[4] = gen_rtx_REG (CC_PREDmode, REGNO (operands[1]));
   operands[5] = gen_rtx_REG (CC_PREDmode, REGNO (operands[1]) + 1);")
...
(define_split
  ...
  [(set (match_dup 4) (match_dup 3))
   ...
   (cond_exec (ne (match_dup 2) (const_int 0))
     (set (match_dup 0) (const_int 0)))
   (set (match_dup 0) (unspec:BI [(match_dup 0)] UNSPEC_PRED_REL_MUTEX))]
  "operands[3] = gen_rtx_REG (CC_PREDmode, REGNO (operands[1]));
   operands[4] = gen_rtx_REG (CC_PREDmode, REGNO (operands[2]));")
...
(define_peephole2
  [(set (match_operand:BI 0 "register_operand" "")
   ...
   (set (match_operand:CC_PRED 2 "register_operand" "")
	(match_operand:CC_PRED 3 "register_operand" ""))
   (set (match_operand:CC_PRED 4 "register_operand" "")
	(match_operand:CC_PRED 5 "register_operand" ""))
