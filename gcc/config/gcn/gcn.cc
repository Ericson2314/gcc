...
static rtx
gcn_mt_libcall_value (machine_mode mode, const_rtx)
{
  return LIBCALL_VALUE (MACRO_MODE (mode));
}

static void
gcn_mt_print_operand (FILE *stream, rtx x, int code)
{
  PRINT_OPERAND (stream, x, code);
}

static void
gcn_mt_print_operand_address (FILE *stream, machine_mode, rtx x)
{
  PRINT_OPERAND_ADDRESS (stream, x);
}

static bool
gcn_mt_print_operand_punct_valid_p (unsigned char code)
{
  return PRINT_OPERAND_PUNCT_VALID_P (code);
}

static bool
gcn_mt_profile_before_prologue (void)
{
...
#define TARGET_LIBCALL_VALUE gcn_mt_libcall_value
#undef TARGET_PRINT_OPERAND
#define TARGET_PRINT_OPERAND gcn_mt_print_operand
#undef TARGET_PRINT_OPERAND_ADDRESS
#define TARGET_PRINT_OPERAND_ADDRESS gcn_mt_print_operand_address
#undef TARGET_PRINT_OPERAND_PUNCT_VALID_P
#define TARGET_PRINT_OPERAND_PUNCT_VALID_P gcn_mt_print_operand_punct_valid_p
#undef TARGET_PROFILE_BEFORE_PROLOGUE
#define TARGET_PROFILE_BEFORE_PROLOGUE gcn_mt_profile_before_prologue
