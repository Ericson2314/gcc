...
static bool
mn10300_mt_function_value_regno_p (const unsigned int regno)
{
  return FUNCTION_VALUE_REGNO_P (regno);
}

static void
mn10300_mt_print_operand (FILE *stream, rtx x, int code)
{
  PRINT_OPERAND (stream, x, code);
}

static void
mn10300_mt_print_operand_address (FILE *stream, machine_mode, rtx x)
{
  PRINT_OPERAND_ADDRESS (stream, x);
}

#undef TARGET_FUNCTION_VALUE_REGNO_P
#define TARGET_FUNCTION_VALUE_REGNO_P mn10300_mt_function_value_regno_p
#undef TARGET_PRINT_OPERAND
#define TARGET_PRINT_OPERAND mn10300_mt_print_operand
#undef TARGET_PRINT_OPERAND_ADDRESS
#define TARGET_PRINT_OPERAND_ADDRESS mn10300_mt_print_operand_address
