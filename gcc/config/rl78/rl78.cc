...
static unsigned char
rl78_mt_class_max_nregs (reg_class_t rclass, machine_mode mode)
{
...
static bool
rl78_mt_function_value_regno_p (const unsigned int regno)
{
  return FUNCTION_VALUE_REGNO_P (regno);
}

static rtx
rl78_mt_libcall_value (machine_mode mode, const_rtx)
{
  return LIBCALL_VALUE (MACRO_MODE (mode));
}

static bool
rl78_mt_profile_before_prologue (void)
{
...
#define TARGET_CLASS_MAX_NREGS rl78_mt_class_max_nregs
#undef TARGET_FUNCTION_VALUE_REGNO_P
#define TARGET_FUNCTION_VALUE_REGNO_P rl78_mt_function_value_regno_p
#undef TARGET_LIBCALL_VALUE
#define TARGET_LIBCALL_VALUE rl78_mt_libcall_value
#undef TARGET_PROFILE_BEFORE_PROLOGUE
#define TARGET_PROFILE_BEFORE_PROLOGUE rl78_mt_profile_before_prologue
