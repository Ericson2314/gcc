...
pa_mt_class_max_nregs (reg_class_t rclass, machine_mode mode)
{
...
static void
pa_mt_print_operand (FILE *stream, rtx x, int code)
{
  PRINT_OPERAND (stream, x, code);
}

static void
pa_mt_print_operand_address (FILE *stream, machine_mode, rtx x)
{
  PRINT_OPERAND_ADDRESS (stream, x);
}

static bool
pa_mt_profile_before_prologue (void)
{
...
#define TARGET_CLASS_MAX_NREGS pa_mt_class_max_nregs
#undef TARGET_PRINT_OPERAND
#define TARGET_PRINT_OPERAND pa_mt_print_operand
#undef TARGET_PRINT_OPERAND_ADDRESS
#define TARGET_PRINT_OPERAND_ADDRESS pa_mt_print_operand_address
#undef TARGET_PROFILE_BEFORE_PROLOGUE
#define TARGET_PROFILE_BEFORE_PROLOGUE pa_mt_profile_before_prologue
