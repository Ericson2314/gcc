...
loongarch_mt_class_max_nregs (reg_class_t rclass, machine_mode mode)
{
...
static bool
loongarch_mt_function_value_regno_p (const unsigned int regno)
{
  return FUNCTION_VALUE_REGNO_P (regno);
}

#undef TARGET_CLASS_MAX_NREGS
#define TARGET_CLASS_MAX_NREGS loongarch_mt_class_max_nregs
#undef TARGET_FUNCTION_VALUE_REGNO_P
#define TARGET_FUNCTION_VALUE_REGNO_P loongarch_mt_function_value_regno_p
