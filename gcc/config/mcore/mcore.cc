...
mcore_mt_class_max_nregs (reg_class_t rclass, machine_mode mode)
{
...
static rtx
mcore_mt_function_value (const_tree ret_type, const_tree fn_decl_or_type, bool)
{
...
static bool
mcore_mt_function_value_regno_p (const unsigned int regno)
{
  return FUNCTION_VALUE_REGNO_P (regno);
}

static rtx
mcore_mt_libcall_value (machine_mode mode, const_rtx)
{
  return LIBCALL_VALUE (MACRO_MODE (mode));
}

static reg_class_t
mcore_mt_preferred_reload_class (rtx x, reg_class_t rclass)
{
  return (reg_class_t) PREFERRED_RELOAD_CLASS (x, (enum reg_class) rclass);
}

#undef TARGET_CLASS_MAX_NREGS
#define TARGET_CLASS_MAX_NREGS mcore_mt_class_max_nregs
#undef TARGET_FUNCTION_VALUE
#define TARGET_FUNCTION_VALUE mcore_mt_function_value
#undef TARGET_FUNCTION_VALUE_REGNO_P
#define TARGET_FUNCTION_VALUE_REGNO_P mcore_mt_function_value_regno_p
#undef TARGET_LIBCALL_VALUE
#define TARGET_LIBCALL_VALUE mcore_mt_libcall_value
#undef TARGET_PREFERRED_RELOAD_CLASS
#define TARGET_PREFERRED_RELOAD_CLASS mcore_mt_preferred_reload_class
