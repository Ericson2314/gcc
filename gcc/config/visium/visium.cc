...
visium_mt_class_max_nregs (reg_class_t rclass, machine_mode mode)
{
...
static bool
visium_mt_function_value_regno_p (const unsigned int regno)
{
  return FUNCTION_VALUE_REGNO_P (regno);
}

static reg_class_t
visium_mt_preferred_reload_class (rtx x, reg_class_t rclass)
{
  return (reg_class_t) PREFERRED_RELOAD_CLASS (x, (enum reg_class) rclass);
}

#undef TARGET_CLASS_MAX_NREGS
#define TARGET_CLASS_MAX_NREGS visium_mt_class_max_nregs
#undef TARGET_FUNCTION_VALUE_REGNO_P
#define TARGET_FUNCTION_VALUE_REGNO_P visium_mt_function_value_regno_p
#undef TARGET_PREFERRED_RELOAD_CLASS
#define TARGET_PREFERRED_RELOAD_CLASS visium_mt_preferred_reload_class
