#!/bin/sh
# Task #106: run target-specs' OWN configure, once per target, in /tmp/b24/gcc.
#
...
SRC=/home/jcericson/src/gnu/gcc/.claude/worktrees/agent-ad79a17e47a430c73
D=${D:-/tmp/b24}
...
for t in x86_64-pc-linux-gnu aarch64-unknown-linux-gnu; do
  nix-shell -I "nixpkgs=$NP" \
    ...
    > /tmp/t24-ts-$t.log 2>&1 || { echo "configure FAILED for $t"; rc=1; }
