#!/bin/sh
# #169 (copied verbatim from t160-specs.sh; only the worktree name in the build-dir assertion differs) -- run the per-target `target-specs' probe for the two configured
