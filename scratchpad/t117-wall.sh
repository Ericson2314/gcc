#!/bin/sh
# TASK #117 -- where aarch64 stops NOW, under gdb, on scratchpad/big.c.
#
...
D=${D:-/tmp/b117}
IN=${IN:-/home/jcericson/src/gnu/gcc/.claude/worktrees/agent-a75a2f51f92af9802/scratchpad/big.c}
O=${O:-/tmp/t117-wall}
mkdir -p "$O"
