...
#
# Copied from agent-a01e6c604f26604a7-drive.sh with only the ID changed, which
# is the whole point of mt-lib.sh deriving its tag: nothing else needed an
# edit.  Detached (`setsid nohup') and NOT a harness background task -- the
