#!/bin/sh
# Task #106: run target-specs' OWN configure, once per target, in /tmp/b113/gcc.
#
...
SRC=/home/jcericson/src/gnu/gcc/.claude/worktrees/agent-a8e4f809d46e47098
D=${D:-/tmp/b113}
...
for t in x86_64-pc-linux-gnu aarch64-unknown-linux-gnu; do
  nix-shell -I "nixpkgs=$NP" \
    ...
    > /tmp/t113-ts-$t.log 2>&1 || { echo "configure FAILED for $t"; rc=1; }
