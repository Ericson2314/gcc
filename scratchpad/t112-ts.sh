#!/bin/sh
# Task #106: run target-specs' OWN configure, once per target, in /tmp/b112/gcc.
#
...
SRC=/home/jcericson/src/gnu/gcc/.claude/worktrees/agent-aa0b6da0fbac13315
D=${D:-/tmp/b112}
...
for t in x86_64-pc-linux-gnu aarch64-unknown-linux-gnu; do
  nix-shell -I "nixpkgs=$NP" \
    ...
    > /tmp/t112-ts-$t.log 2>&1 || { echo "configure FAILED for $t"; rc=1; }
