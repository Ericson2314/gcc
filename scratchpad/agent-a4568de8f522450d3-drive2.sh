...
#   post   fe9cbaf5163  + ASM_DECLARE_FUNCTION_SIZE   (the POP half; riscv)
#   post3  3d961951ccc  + ASM_OUTPUT_FUNCTION_PREFIX  (the PUSH half; s390)
#                       + ADJUST_INSN_LENGTH          (13 back ends)
#
# so pre->post is the pop alone, post->post3 the other two, pre->post3 all.
set -u
...
grep -q '#ifdef ADJUST_INSN_LENGTH' "$S/gcc/final.cc" \
